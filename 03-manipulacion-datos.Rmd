# Manipulacion y agrupacion de datos 
...
download.file("https://github.com/diegovalle/mxmaps/blob/master/data/df_mxmunicipio.RData?raw=true", "data/df_mxmunicipio.RData")
```

```{r}
load("data/df_mxmunicipio.RData")
```
